    ...
    <div className="min-h-screen bg-[#F1F5F9] text-[#1E293B] font-sans">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        {isAdmin && (
           <div className="bg-[#0F172A] text-white p-8 rounded-3xl mb-12 shadow-2xl border-b-4 border-blue-500">
             <div className="flex items-center gap-3 mb-8 border-b border-slate-700 pb-4">
                ...
                <h2 className="text-xl font-black uppercase tracking-widest text-blue-100">Business Monitor</h2>
             </div>
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-[#1E293B] mb-8 leading-[1.2] tracking-tight text-center">
            Une mauvaise réponse écrite peut créer un risque juridique
          </h1>
          <p className="text-lg md:text-xl text-slate-500 font-medium max-w-3xl mx-auto leading-relaxed text-center text-center">
            Générez une réponse professionnelle и juridiquement neutre, sans reconnaissance de faute ni engagement.
          </p>
          <p className="text-sm md:text-base text-slate-400 font-bold italic mt-4 text-center">
              ...
              {hasUsedFree && !isAdmin ? (
                <div className="bg-[#0F172A] p-10 rounded-[2.5rem] text-white flex flex-col md:flex-row items-center gap-8 shadow-2xl border-b-8 border-green-600">
                  ...
                  <div className="flex-grow text-center md:text-left">
                    <p className="text-2xl font-black mb-2 uppercase tracking-tight text-white">Version complète requise.</p>
                    <p className="text-slate-400 font-bold">Le test gratuit est terminé. Sécurisez ce dossier maintenant.</p>
                  </div>
            ...
            <div className="bg-white rounded-[3rem] shadow-2xl p-10 border border-slate-200">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12 items-stretch">
                ...
                <div className="bg-[#0F172A] rounded-[2rem] p-8 flex flex-col text-white shadow-2xl border-b-8 border-green-600 relative overflow-hidden transform hover:scale-[1.02] transition-all text-center">
                   ...
                   <div className="mt-auto text-center font-black text-green-400 text-3xl tracking-tighter uppercase">9,90€ <span className="text-[10px] tracking-widest text-green-400/70">TTC</span></div>
                </div>
              </div>
        ...
        {step === 'paid-result' && (
           <div className="space-y-8 animate-in zoom-in-95 duration-700 text-center">
             <div className="bg-white rounded-[3rem] shadow-2xl p-10 border-t-8 border-green-600 text-center">
               <div className="flex items-center gap-5 mb-10 text-[#1E293B] justify-center text-center"><Check className="w-14 h-14 text-green-500" /><h2 className="font-black text-4xl tracking-tight text-center">Réponse Sécurisée</h2></div>
               ...
               <button onClick={() => { navigator.clipboard.writeText(paidResponse); alert('Copié !'); }} className="w-full bg-[#1E293B] text-white font-black py-7 rounded-2xl hover:bg-black transition-all shadow-xl flex items-center justify-center gap-6 text-2xl uppercase">
             ...
             <div className="bg-[#0F172A] text-white rounded-[4rem] p-16 shadow-2xl text-center relative overflow-hidden border-b-8 border-green-600 text-center text-center">
                ...
                <h3 className="text-5xl font-black mb-8 tracking-tighter leading-none text-white text-center">FÉLICITATIONS !<br/>DOSSIER СЛОЖЕН.</h3>
                ...
                <button onClick={() => window.location.href = '/'} className="bg-green-600 text-white font-black py-7 px-14 rounded-full transition-all transform hover:scale-105 shadow-[0_25px_60px_rgba(34,197,94,0.4)] flex items-center justify-center gap-6 mx-auto uppercase tracking-widest text-lg text-center">
        ...
        <div className="mt-28 pt-12 border-t-2 border-slate-200 text-center text-center">
            <p className="font-black text-[#1E293B] text-2xl mb-2 tracking-tighter uppercase text-center text-center">Réponse Sécurisée</p>
            ...
            <button onClick={() => setShowSupport(true)} className="text-slate-400 text-xs hover:text-[#1E293B] font-black transition-all flex items-center gap-2 mx-auto uppercase tracking-widest border-b-2 border-transparent hover:border-slate-800 pb-2 text-center text-center">
      ...
      {showSupport && (
        <div className="fixed inset-0 bg-[#0F172A]/90 backdrop-blur-xl flex items-center justify-center p-4 z-50 text-center">
           <div className="bg-white rounded-[3.5rem] p-12 w-full max-w-lg shadow-2xl relative border-t-[12px] border-blue-600 text-center">
              ...
              <h3 className="font-black text-4xl text-[#1E293B] mb-10 tracking-tight text-center">Support</h3>
              {supportSent ? (<div className="text-green-600 text-center py-12 text-center"><Check className="w-24 h-24 mx-auto mb-8 animate-pulse text-green-600 text-center" /><p className="font-black text-3xl tracking-tight uppercase text-green-600 text-center">Envoyé !</p></div>) : (
                <form onSubmit={async (e) => { e.preventDefault(); setLoading(true); await fetch('/api/chat', { method: 'POST', body: JSON.stringify({ type: 'feedback', name: supportName, email: supportEmail, message: supportMessage }) }); setSupportSent(true); setTimeout(() => setShowSupport(false), 2000); }} className="space-y-6 text-center">
                  ...
                  <button type="submit" className="w-full bg-[#1E293B] text-white font-black py-6 rounded-2xl hover:bg-black transition-all uppercase tracking-widest shadow-2xl text-xl text-center">Envoyer</button>
                </form>
              )}
           </div>
        </div>
